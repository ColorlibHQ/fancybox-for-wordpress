							...
							<td>
								<fieldset>
									...
									<label for="imageScale">
										<input type="checkbox" class="custom-switch" name="mfbfw[imageScale]" id="imageScale"<?php if ( isset($settings['imageScale']) && $settings['imageScale'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="centerOnScroll">
										<input type="checkbox" class="custom-switch" name="mfbfw[centerOnScroll]" id="centerOnScroll"<?php if ( isset($settings['centerOnScroll']) && $settings['centerOnScroll'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="hideOnContentClick">
										<input type="checkbox" class="custom-switch" name="mfbfw[hideOnContentClick]" id="hideOnContentClick"<?php if ( isset($settings['hideOnContentClick']) && $settings['hideOnContentClick'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="hideOnOverlayClick">
										<input type="checkbox" class="custom-switch" name="mfbfw[hideOnOverlayClick]" id="hideOnOverlayClick"<?php if ( isset($settings['hideOnOverlayClick']) && $settings['hideOnOverlayClick'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="enableEscapeButton">
										<input type="checkbox" class="custom-switch" name="mfbfw[enableEscapeButton]" id="enableEscapeButton"<?php if ( isset($settings['enableEscapeButton']) && $settings['enableEscapeButton'] ) echo ' checked="yes"';?> />
						...
						<tr valign="top">
							...
							<td>
								<fieldset>
									...
									<label for="cyclic">
										<input type="checkbox" class="custom-switch" name="mfbfw[cyclic]" id="cyclic"<?php if ( isset($settings['cyclic']) && $settings['cyclic'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="mouseWheel">
										<input type="checkbox" class="custom-switch" name="mfbfw[mouseWheel]" id="mouseWheel"<?php if ( isset($settings['mouseWheel']) && $settings['mouseWheel'] ) echo ' checked="yes"';?> />
