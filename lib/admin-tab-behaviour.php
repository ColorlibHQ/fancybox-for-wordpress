							...
							<td>
								<fieldset>
									...
									<label for="imageScale">
										<input type="checkbox" name="mfbfw[imageScale]" id="imageScale"<?php if ( isset($mfbfw['imageScale']) && $mfbfw['imageScale'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="centerOnScroll">
										<input type="checkbox" name="mfbfw[centerOnScroll]" id="centerOnScroll"<?php if ( isset($mfbfw['centerOnScroll']) && $mfbfw['centerOnScroll'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="hideOnContentClick">
										<input type="checkbox" name="mfbfw[hideOnContentClick]" id="hideOnContentClick"<?php if ( isset($mfbfw['hideOnContentClick']) && $mfbfw['hideOnContentClick'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="hideOnOverlayClick">
										<input type="checkbox" name="mfbfw[hideOnOverlayClick]" id="hideOnOverlayClick"<?php if ( isset($mfbfw['hideOnOverlayClick']) && $mfbfw['hideOnOverlayClick'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="enableEscapeButton">
										<input type="checkbox" name="mfbfw[enableEscapeButton]" id="enableEscapeButton"<?php if ( isset($mfbfw['enableEscapeButton']) && $mfbfw['enableEscapeButton'] ) echo ' checked="yes"';?> />
							...
							<td>
								<fieldset>
									...
									<label for="mouseWheel">
										<input type="checkbox" name="mfbfw[mouseWheel]" id="mouseWheel"<?php if ( isset($mfbfw['mouseWheel']) && $mfbfw['mouseWheel'] ) echo ' checked="yes"';?> />
