						...
						<tr valign="top">
							...
							<td>
								<fieldset>
									...
									<input id="galleryTypeAll" class="galleryType" type="radio" value="all" name="mfbfw[galleryType]"<?php if ($mfbfw['galleryType'] == 'all') echo ' checked="yes"';?> />
									<label for="galleryTypeAll">
										<?php _e('Make a gallery for all images on the page (default)', 'mfbfw'); ?>
									</label><br />

									<input id="galleryTypeNone" class="galleryType" type="radio" value="none" name="mfbfw[galleryType]"<?php if ($mfbfw['galleryType'] == 'none') echo ' checked="yes"';?> />
									...
									<input id="galleryTypePost" class="galleryType" type="radio" value="post" name="mfbfw[galleryType]"<?php if ($mfbfw['galleryType'] == 'post') echo ' checked="yes"';?> />
									...
									<input id="galleryTypeCustom" class="galleryType" type="radio" value="custom" name="mfbfw[galleryType]"<?php if ($mfbfw['galleryType'] == 'custom') echo ' checked="yes"';?> />
									...
									<label for="mfbfw[customExpression]">
										<textarea rows="10" cols="50" class="large-text code" name="mfbfw[customExpression]" wrap="physical" id="customExpression"><?php echo ($mfbfw['customExpression']); ?></textarea>
									</label><br />
