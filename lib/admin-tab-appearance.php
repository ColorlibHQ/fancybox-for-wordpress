...
<table class="form-table fancy-table" style="clear:none;">
	<tbody>
		<tr valign="top">
			...
			<td>
				<fieldset>
					<input type="checkbox" class="onoffswitch-checkbox" name="mfbfw[showCloseButton]" id="showCloseButton"<?php if ( isset( $settings[ 'showCloseButton' ] ) && $settings[ 'showCloseButton' ] ) echo ' checked="yes"'; ?> />					
					<label for="showCloseButton" class="onoffswitch-label">						
					</label>
					<span class="switch-text"><?php _e( 'Show Close button (default: on)', 'mfbfw' ); ?></span><div class="cf"></div><br /><br />
				</fieldset>
			</td>
		</tr>
		<tr valign="top">
			...
			<td>
				<fieldset>
					<input class="onoffswitch-checkbox" type="checkbox" name="mfbfw[border]" id="border"<?php if ( isset( $settings[ 'border' ] ) && $settings[ 'border' ] ) echo ' checked="yes"'; ?> />
					<label for="border" class="onoffswitch-label"></label>					
					<span class="switch-text"><?php _e( 'Show Border (default: off)', 'mfbfw' ); ?></span><div class="cf"></div>
					<br /><br />
					<div id="borderColorBlock">

						<label for="borderColor">
							<input type="text" class="color-btn" name="mfbfw[borderColor]" id="borderColor" value="<?php echo $settings[ 'borderColor' ] ?>" size="7" maxlength="7" />
			...
			<td>
				<fieldset>
					<label for="paddingColor">
						<input type="text"class="color-btn" name="mfbfw[paddingColor]" id="paddingColor" value="<?php echo $settings[ 'paddingColor' ] ?>" size="7" maxlength="7" />
					...
					<label for="padding" class="inlined">
						<input type="text" class="slider-text" name="mfbfw[padding]" id="padding" value="<?php echo $settings[ 'padding' ]; ?>" size="7" maxlength="7" />
						<div class="slider-horizontal" minSl="0" maxSl="100" stepSl="1" rangeSl="min" style="height:14px;"></div>
						<div class="cf"></div><span class="slider-spantext"><?php _e( 'Padding size in pixels (default: 10)', 'mfbfw' ); ?></span>
					</label><br /><br />
				</fieldset>
			</td>
		</tr>
		<tr valign="top">
			...
			<td>
				<fieldset>
					<input type="checkbox" class="onoffswitch-checkbox" name="mfbfw[overlayShow]" id="overlayShow"<?php if ( isset( $settings[ 'overlayShow' ] ) && $settings[ 'overlayShow' ] ) echo ' checked="yes"'; ?> />
					<label for="overlayShow" class="onoffswitch-label"></label>
					<span class="switch-text"><?php _e( 'Add overlay (default: on)', 'mfbfw' ); ?></span><br /><br />

					<div id="overlayBlock">

						<label for="overlayColor">
							<input type="text"class="color-btn" name="mfbfw[overlayColor]" id="overlayColor" value="<?php echo $settings[ 'overlayColor' ]; ?>" size="7" maxlength="7" />
							<?php _e( 'HTML color of the overlay (default: #666666)', 'mfbfw' ); ?>
						</label><br /><br />

						<label for="overlayOpacity" class="inlined">							
							<input type="text" class="slider-text" name="mfbfw[overlayOpacity]" id="overlayOpacity" value="<?php echo $settings[ 'overlayOpacity' ]; ?>" size="7" maxlength="7" />
							<div class="slider-horizontal"  minSl="0" maxSl="1" stepSl="0.1" rangeSl="min" style="height:14px;"></div>
							<div class="cf"></div><span class="slider-spantext"><?php _e( 'Opacity of overlay. 0 is transparent, 1 is opaque (default: 0.3)', 'mfbfw' ); ?></span>
						</label><br /><br />
		...
		<tr valign="top">
			...
			<td>
				<fieldset>
					<input type="checkbox" class="onoffswitch-checkbox" name="mfbfw[titleShow]" id="titleShow"<?php if ( isset( $settings[ 'titleShow' ] ) && $settings[ 'titleShow' ] ) echo ' checked="yes"'; ?> />
					<label for="titleShow" class="onoffswitch-label"></label>
					<span class="switch-text"><?php _e( 'Show the title (default: on)', 'mfbfw' ); ?></span><div class="cf"></div><br /><br />
					<div id="titleBlock">
						<label for="titleSize">
						...
						<div id="titleColorBlock">
							...
							<label for="titleColor">
								<input type="text"class="color-btn" name="mfbfw[titleColor]" id="titleColor" class="colorpick" value="<?php echo $settings[ 'titleColor' ]; ?>" size="7" maxlength="7" />
		...
		<tr valign="top">
			...
			<td>
				<fieldset>
					...
					<span class="switch-text"><?php _e( 'Show the navigation arrows (default: on)', 'mfbfw' ); ?></span><div class="cf"></div><br /><br />
