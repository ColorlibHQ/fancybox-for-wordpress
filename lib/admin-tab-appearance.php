...
<!--		<tr valign="top">
			...
			<td>
				<fieldset>
					...
					<label for="showCloseButton" class="onoffswitch-label"></label>
					<?php _e( 'Show Close button (default: on)', 'mfbfw' ); ?><br /><br />
		...
		<tr valign="top">
			...
			<td>
				<fieldset>
					...
					<?php _e( 'Add overlay (default: on)', 'mfbfw' ); ?><br /><br />
					...
					<div id="overlayBlock">
						...
						<label for="overlayOpacity" class="inlined">
							...
							foreach ( $overlayArray as $key => $opacity ) {
								if ( $settings[ 'overlayOpacity' ] != $opacity )
									$selected	 = '';
								else
									$selected	 = ' selected';
		...
		<tr valign="top">
			...
			<td>
				<fieldset>
					...
					<?php _e( 'Show the title (default: on)', 'mfbfw' ); ?><br /><br />
