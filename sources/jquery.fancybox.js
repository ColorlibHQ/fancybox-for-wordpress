...
(function(b) {
	...
	b.fancybox.init = function() {
		if(!b("#fancybox-wrap").length) {
			...
			D.append(j = b('<div id="fancybox-content"></div>'), E = b('<a id="fancybox-close" class="btn"><i class="icon"></i></a>'), n = b('<div id="fancybox-title"></div>'), z = b('<a href="javascript:;" id="fancybox-left"><span class="fancy-ico btn" id="fancybox-left-ico"><i class="icon"></i></span></a>'), A = b('<a href="javascript:;" id="fancybox-right"><span class="fancy-ico btn" id="fancybox-right-ico"><i class="icon"></i></span></a>'));
