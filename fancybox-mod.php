<?php
	...
	*/
	...
	function mfbfw_admin_styles() {
		...
		wp_enqueue_style( 'fancy-plugin-ui', FBFW_URL . 'css/fancy-ui.css' ); // Load Razvan Test Styles	
		wp_enqueue_style( 'on-off-switch-style', FBFW_URL . 'css/on-off-switch.css' ); // Load Razvan Test Styles	
		wp_enqueue_style( 'wp-color-picker');
		wp_enqueue_style( 'jquery-ui', FBFW_URL . 'css/jquery-ui.css' ); // Load jQuery UI Tabs CSS for Admin Page
		wp_enqueue_style( 'css-codemirror', FBFW_URL . 'codemirror/css/codemirror.css' ); // Load Codemirror CSS for Admin Page
		wp_enqueue_style( 'jQuery-ui', '//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css' ); // Load jQuery-ui CSS
	...
	function mfbfw_admin_scripts() {
		...
		wp_enqueue_script('codemirror-script', FBFW_URL . 'codemirror/js/codemirror.js' ); // Codemirror script for Admin Page
		wp_enqueue_script('codemirror-javascript-model', FBFW_URL . 'codemirror/model/javascript/javascript.js' ); // Codemirror javascript model for Admin Page
		wp_enqueue_script('on-off-switch-script', FBFW_URL . 'js/jquery-on-off-switch.js' ); // On Off switch for Admin Page
	}
